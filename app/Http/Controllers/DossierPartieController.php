...
class DossierPartieController extends Controller
{
    ...
    public function store(Request $request, DossierJudiciaire $dossier): RedirectResponse
    {
        ...
        $request->validate([
            ...
            'nom_partie'         => ['required_without:partie_existante_id', 'nullable', 'string', 'max:255'],
            'type_personne'      => ['required_without:partie_existante_id', 'nullable', 'in:Physique,Morale'],
        ...
        // Chercher ou créer la partie par identifiant unique (CIN / RC / etc.)
