...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">المحاكم</li>
@endsection
        ...
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <div class="text-muted small">إجمالي المحاكم</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <div class="text-muted small">الأقاليم المغطاة</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <div class="text-muted small">القضاة المسجلون</div>
                </div>
            </div>
        </div>
    </div>
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white d-flex align-items-center justify-content-between py-3">
        ...
        <a href="{{ route('tribunaux.create') }}" class="btn btn-primary btn-sm">
            <i class="bi bi-plus-lg me-1"></i>محكمة جديدة
        </a>
    </div>
            ...
            <tbody>
                    ...
                    <td class="ps-3">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-muted small">محكمة</div>
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    <td colspan="6" class="text-center py-5 text-muted">
                        ...
                        لم يتم العثور على أي محكمة
                        @if(request()->hasAny(['search', 'type']))
                            — <a href="{{ route('tribunaux.index') }}">إعادة تعيين الفلاتر</a>
                        @endif
                    </td>
                </tr>
                @endforelse
    ...
    <div class="card-footer bg-white d-flex justify-content-between align-items-center py-3">
        <span class="text-muted small">
            عرض {{ $tribunaux->firstItem() }}–{{ $tribunaux->lastItem() }}
            من أصل {{ $tribunaux->total() }} محكمة
        </span>
        {{ $tribunaux->links() }}
    </div>
    @endif
