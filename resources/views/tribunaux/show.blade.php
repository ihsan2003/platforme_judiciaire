        ...
        <div class="card border-0 shadow-sm">
            ...
            @if($tribunal->juges->isEmpty())
                <div class="card-body text-center py-5 text-muted">
                    ...
                    لا يوجد قضاة مرتبطون بهذه المحكمة.
                </div>
            @else
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <thead class="table-light">
                        <tr>
                            <th class="ps-3 small text-muted fw-semibold">الاسم الكامل</th>
                            <th class="small text-muted fw-semibold">الدرجة</th>
                            <th class="small text-muted fw-semibold">التخصص</th>
                            <th class="text-end pe-3 small text-muted fw-semibold">الإجراءات</th>
                        </tr>
                    </thead>
