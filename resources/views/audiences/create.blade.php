...
<form method="POST" action="{{ route('audiences.store') }}">
    ...
    <input type="date" name="date_prochaine_audience">

    <label>Présence demandeur</label>
    <input type="checkbox" name="presence_demandeur" value="1">

    <label>Présence défendeur</label>
    <input type="checkbox" name="presence_defendeur" value="1">

    <label>Résultat</label>
    <textarea name="resultat_audience"></textarea>

    <label>Actions demandées</label>
    <textarea name="actions_demandees"></textarea>
